...
if __name__ == '__main__':
    merge_file_dir = ['E:/Document/Datasets/FDDB/FDDB-folds/','E:/Document/Datasets/FDDB/FDDB-folds/','../data/FDDB_OUTPUT/']

    o_file_names = ['Fold_all.txt','FDDB-fold-all-ellipseList.txt','FDDB-det-fold-all.txt']

    for i in range(3):

        output_f_name = os.path.join("../data/FDDB_OUTPUT/", o_file_names[i])
