...
class P_Net(keras.Model):
    def __init__(self):
        ...
        self.prelu1 = keras.layers.PReLU(shared_axes=[1, 2], name="prelu1")
        ...
        self.prelu2 = keras.layers.PReLU(shared_axes=[1, 2], name="prelu2")
        self.conv3 = keras.layers.Conv2D(32, (3, 3), name="conv3", kernel_regularizer=keras.regularizers.l2(0.0005))
        self.prelu3 = keras.layers.PReLU(shared_axes=[1, 2], name="prelu3")
